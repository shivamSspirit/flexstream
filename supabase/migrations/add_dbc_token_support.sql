...
-- Create view for trending tokens
...
COMMENT ON VIEW token_leaderboard IS 'Top tokens by market cap with creator info';
COMMENT ON VIEW trending_tokens IS 'Trending tokens based on recent activity';
