...
export async function POST(request: NextRequest) {
  try {
    ...
    // TODO: integrate on-chain sell via wallet adapter/server wallet
    return NextResponse.json({ success: true, action: 'sell', mint, amount, walletAddress: profile.wallet_address });
  } catch (e: any) {
