# FlexStream - Social Platform for Pump.fun Streamers
...
### Core Features
- **Social Feed**: Infinite scroll feed with real-time updates
- **Post Types**: Earnings flexes, stream highlights, lifestyle content, trading journeys
- **User Profiles**: Comprehensive profiles with success tiers and verification
- **Earnings Verification**: Blockchain-based verification system for trading profits
- **Real-time Interactions**: Likes, comments, shares with live updates
- **Mobile-First Design**: Optimized for mobile consumption

### Advanced Features
- **Wallet Integration**: Solana wallet connection for verification
- **Success Tiers**: Bronze, Silver, Gold, Diamond based on verified earnings
- **Leaderboards**: Top earners by week/month
- **Search & Discovery**: Find users, posts, and trending hashtags
...
- **Authentication**: Clerk.dev with Solana wallet integration
...
FlexStream uses a dual authentication system combining email/social login with Solana wallet connection:
